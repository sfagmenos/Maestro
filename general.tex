...
The operators $->$ and $<->$ for concurrency. Also the operators \texttildelow,\texttildelow\textless\\and \texttildelow\textgreater for the job dependancies.\\
...
other.
\subsubsection*{The equal dependancy $($\texttildelow$)$ operator}
The use of this operators states that these jobs should run concurrent if there\\
are enough resources.
\subsubsection*{The prior dependancy $($\texttildelow$>)$ operator}
The use of this operators states that the job at left should run before the one\\
at the right.
\subsubsection*{The later dependancy $($\texttildelow$<)$ operator}
